...
<template>
    <div class="header header-pasien">
        ...
        <p>
            {{ $t("header.greeting") }},
            <span v-text="getUserFirstName(userData.userFullName)"></span>
        </p>
    </div>
    <div class="mt-4 px-4 pt-8">
        ...
        <section class="mt-4">
            <h2 class="fs-3 fw-bold text-black">
                {{ $t("home.what_your_need") }}
            </h2>
            <div class="list-menu-homepage pasien mt-3">
                <router-link
                    to="/history"
                    class="item riwayat-medis bg-blue-100"
                >
                ...
                <router-link
                    :to="{ name: 'DoctorSchedulePage' }"
                    class="item doctor-schedule bg-green-100"
                >
        ...
        <section class="mt-6">
            <h2 class="fs-3 fw-bold text-black">
                {{ $t("home.next_consult_schedule") }}
            </h2>
            <div
                v-if="openAppointments.length > 0"
                id="jadwal-konsultasi"
            ...
            >
                ...
                <p class="mt-2 text-gray-700 fs-5">
                    Buat Jadwal Konsultasi Baru Dengan Mentap Tombol “Buat
                    Jadwal”
                </p>
                <router-link
                    :to="{ name: 'CreateAppointmentPage' }"
                    class="d-block btn btn-blue-500-rounded-sm mt-4 fw-semibold"
                    >Buat Jadwal</router-link
                >
            </div>
            <div
                class="mt-2 px-4 py-3 bg-blue-100 rounded-3 text-center"
            ...
            >
                ...
                <p class="mt-2 text-gray-700 fs-5">
                    Mulai Sinkronisasi Data Anda untuk Mulai Jadwal Konsultasi
                    dengan Tap tombol Sinkronisasi dibawah.
                </p>

                <router-link
                    :to="{ name: 'ProfilePage' }"
                    class="d-block btn btn-blue-500-rounded-sm mt-4 fw-semibold"
                    >Sinkronisasi</router-link
                >
            </div>
        </section>
    </div>
